          ...
          <div className="container-main">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">
                Empowering Learners{" "}
                <span className="text-[#5a85fe]"></span>
              </h1>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="p-8 rounded-3xl bg-gradient-card border border-border/50">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  At MentSource, our mission is to create a supportive ecosystem where anyone regardless of their experience level can learn, grow, and succeed. By offering hands-on training, mentorship programs, and real-world projects, we aim to transform beginners into skilled developers and enable experienced contributors to refine their expertise while giving back to the open-source ecosystem.
                </p>
              </div>
              <div className="p-8 rounded-3xl bg-gradient-card border border-border/50">
